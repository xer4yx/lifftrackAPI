...
class TestComVisUseCase(unittest.TestCase):
    def setUp(self):
        ...
        self.expected_keypoints = KeypointCollection(keypoints={
    ...
    def test_analyze_exercise_form(self):
        ...
        self.mock_pose_feature_repo.detect_form_issues.return_value = ["Issue 1", "Issue 2"]
        self.mock_form_analysis_repo.analyze_form.return_value = mock_analysis
        
        # Call the method
        result = self.use_case.analyze_exercise_form(mock_features, self.test_exercise_name)
    ...
    def test_visualize_form_analysis(self):
        ...
        self.mock_form_analysis_repo.visualize_form_analysis.return_value = visualized_frame
    ...
    def test_perform_frame_analysis(self):
        ...
        self.mock_feature_repo.perform_frame_analysis.return_value = (
            current_pose, previous_pose, detected_object, class_name
        )
        ...
        # Assertions
        self.mock_feature_repo.perform_frame_analysis.assert_called_once_with(frames_buffer, mock_request)
        self.assertEqual(result, (current_pose, previous_pose, detected_object, class_name))
    ...
    def test_load_to_object_model(self):
        ...
        # Assertions
        self.mock_feature_repo.load_to_object_model.assert_called_once_with(object_inference)
    ...
    def test_process_frame_with_keypoints(self):
        ...
        self.use_case.visualize_keypoints = MagicMock(return_value=visualized_keypoints_frame)
        self.use_case.visualize_form_analysis = MagicMock(return_value=visualized_analysis_frame)
        ...
        self.use_case.img_to_base64.assert_called_once_with(
            visualized_analysis_frame
        )
