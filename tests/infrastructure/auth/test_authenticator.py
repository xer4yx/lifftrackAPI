...
from infrastructure.auth.token_blacklist_repository import InMemoryTokenBlacklistRepository
...
class TestAuthenticator:
    ...
    @pytest.mark.asyncio
    async def test_authenticate_success(self, authenticator, user_repository, test_user):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_wrong_password(self, authenticator, user_repository, test_user):
        ...
        with patch.object(authenticator, 'verify_password', return_value=False):
            credentials = CredentialsEntity(username="testuser", password="WrongPassword")
            user = await authenticator.authenticate(credentials)
    ...
    @pytest.mark.asyncio
    async def test_verify_token_blacklisted(self, authenticator, test_user, token_blacklist):
    ...
    @pytest.mark.asyncio
    async def test_change_password_success(self, authenticator, user_repository, test_user):
    ...
    @pytest.mark.asyncio
    async def test_change_password_invalid_old_password(self, authenticator, user_repository, test_user):
    ...
    @pytest.mark.asyncio
    async def test_change_password_weak_new_password(self, authenticator, user_repository, test_user):
    ...
    @pytest.mark.asyncio
    async def test_is_username_taken_database_check(self, authenticator, user_repository):
