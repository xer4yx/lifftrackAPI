...
class FirebaseOptions(BaseModel):
    ...
    databaseAuthVariableOverride: FirebaseDatabaseAuthVariableOverride = Field(..., description="Firebase auth variable override")
...
class FirebaseSettings(BaseSettings):
    ...
    database_url: Optional[str] = Field(default=None, description="Firebase Realtime Database URL")
    options: Optional[FirebaseOptions] = Field(default=None, description="Firebase options")
    admin_sdk: Optional[str] = Field(default=None, description="Firebase admin SDK path")
...
class MongoDbSettings(BaseSettings):
    ...
    min_pool_size: Optional[int] = Field(default=None, description="MongoDB minimum connection pool size")
    max_pool_size: Optional[int] = Field(default=None, description="MongoDB maximum connection pool size")
    timeout_ms: Optional[int] = Field(default=None, description="MongoDB connection timeout in milliseconds")
