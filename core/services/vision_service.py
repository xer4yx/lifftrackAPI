...
from core.interfaces import ModelInference, FrameRepository
...
class VisionService:
    ...
    def analyze_frame(self, frame: Frame) -> Dict[str, Any]:
        ...
        for model_inference in self.model_inferences:
            inference = model_inference.get_inference(frame, model_inference.model)
            inference_results[str(model_inference.model.__name__)] = inference
