...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        inference_services["posenet"] = InferenceServiceFactory.create_inference_service(
            service_type="posenet",
            config={
                "enable_gpu": False,
                "max_workers": 1
            }
        ...
        inference_services["roboflow"] = InferenceServiceFactory.create_inference_service(
            service_type="roboflow",
            config={
                "max_workers": 1
            }
        )
        ...
        inference_services["videoaction"] = InferenceServiceFactory.create_inference_service(
