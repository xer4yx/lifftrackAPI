...
class WeightliftDataRepository(DataHandlerInterface[ExerciseData, None]):
    ...
    def load_to_data_model(self, features: PoseFeatures, suggestions: str, 
                                 frame_index: str, frame_id: Optional[str] = None) -> ExerciseData:
        """
    ...
    async def save_data(self, username: str, exercise_name: str, date: str,
                   time_frame: str, exercise_data: Dict[str, Any], 
                   db: NTFInterface) -> None:
        """
